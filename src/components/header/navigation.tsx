...
const Navigation = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      images: [
        {
          src: "/arcus-bracelet.png",
          alt: "Arcus Bracelet",
          label: "Arcus Bracelet",
        },
        {
          src: "/span-bracelet.png",
          alt: "Span Bracelet",
          label: "Span Bracelet",
        },
      ],
                ...
                {navItems
                  ...
                  ?.images.map((image, index) => {
                    ...
                    if (activeDropdown === "Shop") {
                      ...
                      else if (image.label === "Earrings")
                        linkTo = "/category/earrings";
                    } else if (activeDropdown === "New in") {
                      if (image.label === "Arcus Bracelet")
                        linkTo = "/product/arcus-bracelet";
                      else if (image.label === "Span Bracelet")
                        linkTo = "/product/span-bracelet";
