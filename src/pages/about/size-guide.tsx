              ...
              <div className="bg-muted/10 rounded-lg p-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                      <li>
                        Wrap string or paper around your finger where the ring
                        will sit
                      </li>
          ...
          <ContentSection title="Need Help?">
            <div className="space-y-6">
              <p className="text-muted-foreground">
                Still unsure about sizing? Our jewelry consultants are here to
                help you find the perfect fit. Download our printable size guide
                or schedule a virtual consultation.
              </p>
