              ...
              <div className="grid md:grid-cols-3 gap-8 mt-12">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm">
                    One-on-one guidance to find the perfect piece for any
                    occasion
                  </p>
                </div>
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Work with our designers to create a unique piece just for
                    you
                  </p>
                </div>
                <div className="space-y-3">
          ...
          <ContentSection title="Virtual Consultations">
            <div className="bg-muted/10 rounded-lg p-8">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                We'll showcase pieces via video call, answer your questions, and
                help you make the perfect selection from the comfort of your
                home.
              </p>
              <Button variant="outline" className="rounded-none">
