          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Linea Jewelry Inc. website and
                services, you accept and agree to be bound by the terms and
                provision of this agreement. These Terms of Service govern your
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                materials on Linea Jewelry Inc.'s website for personal,
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                complete, reliable, or error-free. We reserve the right to
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Payment is due at the time of purchase. We accept major
                    credit cards and other payment methods as displayed during
                    checkout. All prices are in USD unless otherwise specified.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We will make every effort to ship orders within the timeframes
                specified. However, delivery dates are estimates and we are not
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                the carrier. We are not responsible for lost, stolen, or damaged
                packages once they have been delivered to the address provided.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our jewelry comes with a limited warranty against manufacturing
                defects. This warranty does not cover damage from normal wear,
                improper care, or accidents. Proper care instructions are
                provided with each purchase and on our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                graphics, logos, images, and software, is the property of Linea
                Jewelry Inc. and is protected by copyright, trademark, and other
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall Linea Jewelry Inc. or its suppliers be liable
                ...
                of the use or inability to use the materials on our website or
                products, even if we have been notified of the possibility of
                such damage.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Policy, which also governs your use of our website and services,
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                accordance with the laws of New York State, and you irrevocably
